    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          fs.writeFile("output/1.png", buffer, err => {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/2.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/3.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/4.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/5.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
      ...
      n2.on("input", (msg) => {
        try {
          if (count == 0) {
            ...
            // );
            let buffer = Buffer.from(msg.payload, "base64")
            fs.writeFile("output/6.png", buffer, err => {
              if (err) console.error(err)
            })
          } else if (count === 1) {
            // msg.payload.should.equal(
            ...
            // );
            let buffer = Buffer.from(msg.payload, "base64")
            fs.writeFile("output/7.png", buffer, err => {
              if (err) console.error(err)
            })
            done();
          }
      ...
      n2.on("input", (msg) => {
        try {
          if (count === 0) {
            ...
            // );
            let buffer = Buffer.from(msg.payload, "base64")
            fs.writeFile("output/8.png", buffer, err => {
              if (err) console.error(err)
            })
          } else if (count === 1) {
            // msg.payload.should.equal(
            //   ""
            // );
            let buffer = Buffer.from(msg.payload, "base64")
            fs.writeFile("output/9.png", buffer, err => {
              if (err) console.error(err)
            })
            done();
          }
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/10.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/11.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/12.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/13.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/14.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/15.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
      ...
      n2.on("input", (msg) => {
        try {
          if (count === 0) {
            ...
            // );
            let buffer = Buffer.from(msg.payload, "base64")
            fs.writeFile("output/16.png", buffer, err => {
              if (err) console.error(err)
            })
          } else if (count === 1) {
            // msg.payload.should.equal(
            ...
            // );
            let buffer = Buffer.from(msg.payload, "base64")
            fs.writeFile("output/17.png", buffer, err => {
              if (err) console.error(err)
            })
            done()
          }
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/18.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          // );
          let buffer = Buffer.from(msg.payload, "base64")
          fs.writeFile("output/19.png", buffer, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
    ...
    helper.load(chartNode, flow, function () {
      ...
      n2.on("input", (msg) => {
        try {
          ...
          fs.writeFile("output/20.png", binary, err => {
            if (err) console.error(err)
          })
          done()
        } catch (err) {
