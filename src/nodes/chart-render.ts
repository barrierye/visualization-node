...
let default_scales: {[key: string]: any[]} = {'Bar chart': default_bar_scales,
                                              'Line chart': default_line_scales,
                                              'Pie chart': default_pie_scales}

let default_axes: {[key: string]: any[]} = {'Bar chart': default_bar_axes,
                                            'Line chart': default_line_axes}

let default_marks: {[key: string]: any[]} = {'Bar chart': default_bar_marks,
